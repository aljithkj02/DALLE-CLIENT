    ...
    <section className="max-w-7xl mx-auto  mt-20">
      <ToastContainer />
        <div>
            ...
            <p className="mt-2 text-[#666e75] text-[16px] max-w-[600px]">Create imaginative and visually stunning images through by VisualizeAI and share them with the community</p>
        </div>
