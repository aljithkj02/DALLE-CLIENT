...
const Card = ({ _id, name, prompt, photo, normalCard, handler}) => {
  ...
  return (normalCard) ? (
    <div className="rounded-xl group relative shadow-card hover:shadow-cardhover">
      ...
      <div className="group-hover:flex items-center max-h-[94.5%]
        hidden absolute bottom-0 left-0 right-0 bg-[#10131f] m-2 p-4 rounded-md transform hover:-translate-y-1
        duration-300"
      >
          <p className="text-white text-md overflow-y-auto w-[90%]">{ prompt }</p>
