...
const Dialog = ({ message, handlerNo, handlerYes }) => {
  return (
    <div className="fixed top-0 left-0 bottom-0 rght-0 w-full z-10  flex justify-center items-center">
        <div className="flex flex-col justify-center w-96 h-52 items-center bg-black text-white rounded-lg">
